# Idea Validation Reference

Methodology for evaluating product and startup ideas. Use alongside the conversation flow in `SKILL.md`.
...
| Channel | Best For | Effort | Competition |
|---------|----------|--------|-------------|
| Plugin/app store (Claude, ChatGPT, Shopify, Figma) | Tools that extend platforms people already use | Low-medium | Growing fast |
| Search (SEO) | Problems people Google regularly | High upfront, pays off over time | Varies |
| App stores (iOS, Android) | Things people need on their phone | Medium | Very high |
| Reddit / communities | Niche problems with active online communities | Low but manual | Low |
| Marketplaces (Gumroad, Lemon Squeezy) | Templates, tools, digital products | Low | Medium |
| Social / viral | Consumer apps that are visual or shareable | Unpredictable | Very high |
| Paid ads | Proven product with known conversion rates | Requires budget | High |
| Direct outreach | High-value B2B contracts | High effort per sale | Low |
...
|-------|--------------|-----------|
| Monthly subscription | Ongoing value, people use it regularly | People cancel if the core value is a one-time thing |
| Pay per use | Variable usage, like an API or credits-based tool | Hard to predict revenue, users get sticker shock |
| One-time purchase | Tools, templates, digital products | No recurring revenue — need new customers constantly |
| Free tier + paid upgrade | The product gets better with more users (viral growth) | Most users never pay — you need a huge free base |
| Marketplace cut | Connecting buyers and sellers | Chicken-and-egg problem: need both sides at once |
| Sell the work (agency model) | AI-powered service delivery | Requires expertise, harder to scale than software |
...
## Mental Models for Idea Evaluation

### Reversibility × Magnitude (Bezos)

Not all decisions are equal. Before committing to a direction, categorize the decision:

- **High magnitude + irreversible** (Type 1): Choose your primary distribution channel, core business model, whether to build a standalone app vs. a plugin. These are hard to undo — get them right before building.
- **High magnitude + reversible** (Type 2a): Pricing, feature prioritization, go-to-market messaging. High stakes but you can adjust based on feedback.
- **Low magnitude + reversible** (Type 2b): UI details, naming, specific feature implementation. Make a call and move on — the cost of getting it wrong is low.

Apply this to the scorecard: flag which dimensions are Type 1 decisions. Uncertainty in a Type 1 area is a reason to validate before building, not to figure it out as you go.

### Inversion Reflex (Munger)

Instead of asking "how do I make this succeed?", ask "how could this definitely fail?"

For each of the 5 Questions, invert:
- Problem: "What if this problem isn't actually painful enough to pay for?"
- Distribution: "What if user #100 can't find this through any repeatable channel?"
- Defensibility: "What if a well-funded competitor ships this next month?"
- Timing: "What if this window closes before we reach product-market fit?"
- People: "What if the people I think have this problem don't actually want a product for it?"

If you can describe the failure mode clearly, you're either solving for it or knowingly accepting the risk. Vague failure modes are the dangerous ones.

### 10-Star Product

From 1-star (broken, no one would use it) to 10-star (so good users tell everyone, life-changing). Ask: what's the 10-star version of this idea?

The useful move: "What's the version that's 10x more ambitious but only 2x the effort?" This surfaces the insight hidden inside the cautious version. Sometimes the stripped-back MVP leaves the most interesting thing on the table. The 10-star version often reveals a different distribution strategy, a different customer, or a different revenue model.

Use this especially when an idea feels timid or derivative. The founder might be self-censoring the actually-interesting version.

### Dream State Mapping

Where does this put the founder in 12 months if it works? Not "successful startup" — that's a feeling, not a destination. Specific means:

- What are they working on daily?
- Who are the first 100 customers and what do they look like?
- What does the product look like vs. today?
- What problem has been retired from their life?

Dream State Mapping serves two purposes: it makes the vision concrete enough to evaluate, and it reveals whether the founder is actually excited about where this goes. If they can't describe it, they either haven't thought through the idea or they're not that interested in the destination.

### "Boil the Lake" Principle

AI makes completeness cheap. What used to require cutting corners — skipping the onboarding flow, skipping error states, shipping with rough edges — now has no excuse. AI can help build the full version in the time it used to take to build the minimum.

The trap: founders still plan for shortcuts out of habit. When they say "we'll polish that later" or "we'll add error handling after launch," push back. In 2026, "good enough" ships alongside polish. The bar users expect from day one is higher because they know what's possible.

Flag anywhere the plan is counting on users tolerating roughness. That roughness is now avoidable.

### Mode Selection: EXPANSION / HOLD / REDUCTION

Where is the founder right now in their thinking?

**EXPANSION** — They want to go bigger. They're excited and may be underselling the ambition. Use Dream State, 10-Star thinking, and focus on what unlocks the most ambitious version. Surface risks as things to solve, not reasons to stop.

**HOLD** — They want to validate as-is. They're not looking to pivot — they want to know if this version has legs. Focus on execution risks, defensibility gaps, and whether the distribution channel is real. Be direct about what could go wrong.

**REDUCTION** — They want to find the smallest possible thing to prove. They might be overwhelmed or unsure where to start. Find the one killer use case, the one distribution channel that could work, and the one metric that proves the idea. Everything else is noise until that's validated.

Meet the founder where they are. Giving EXPANSION feedback to someone in REDUCTION mode — or vice versa — wastes the conversation.

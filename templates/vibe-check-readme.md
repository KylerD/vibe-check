...
```
Read .vibe-check/checklist/item-001-secrets-management.md and fix it
```

### 3. Track Progress

After making fixes, run `/vibe-check:refresh` to re-analyze your codebase and update these files.
